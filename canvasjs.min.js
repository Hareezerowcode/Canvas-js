...
/*eslint-disable*/
/*jshint ignore:start*/
(function(){function na(h,m){h.prototype=cb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function cb(h){function m(){}m.prototype=h;return new m}function Wa(h,m,v){"millisecond"===v?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===v?h.setSeconds(h.getSeconds()+1*m):"minute"===v?h.setMinutes(h.getMinutes()+1*m):"hour"===v?h.setHours(h.getHours()+1*m):"day"===v?h.setDate(h.getDate()+1*m):"week"===v?h.setDate(h.getDate()+7*m):"month"===v?h.setMonth(h.getMonth()+1*m):"year"===v&&h.setFullYear(h.getFullYear()+
1*m);return h}function Y(h,m){var v=!1;0>h&&(v=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return v?"-"+h:h}function Ea(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,v=h.length;m.test(h.charAt(--v)););return h.slice(0,v+1)}function Aa(h){h.roundRect=function(h,v,t,w,oa,E,x,F){x&&(this.fillStyle=x);F&&(this.strokeStyle=F);"undefined"===typeof oa&&(oa=5);this.lineWidth=E;this.beginPath();this.moveTo(h+oa,v);this.lineTo(h+t-oa,v);this.quadraticCurveTo(h+t,v,h+t,v+oa);this.lineTo(h+t,
v+w-oa);this.quadraticCurveTo(h+t,v+w,h+t-oa,v+w);this.lineTo(h+oa,v+w);this.quadraticCurveTo(h,v+w,h,v+w-oa);this.lineTo(h,v+oa);this.quadraticCurveTo(h,v,h+oa,v);this.closePath();x&&this.fill();F&&0<E&&this.stroke()}}function Qa(h,m){return h-m}function R(h){var m=((h&16711680)>>16).toString(16),v=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;v=2>v.length?"0"+v:v;h=2>h.length?"0"+h:h;return"#"+m+v+h}function db(h,m){var v=this.length>>>0,t=Number(m)||0,t=0>t?Math.ceil(t):
Math.floor(t);for(0>t&&(t+=v);t<v;t++)if(t in this&&this[t]===h)return t;return-1}function t(h){return null===h||"undefined"===typeof h}function Ba(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(Fa.fSDec)h[fa("`eeDwdouMhrudods")](fa("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){Fa._fTWm&&Fa._fTWm(h)})}function Xa(h,m,v){v=v||"normal";var t=h+"_"+m+"_"+v,w=Ya[t];if(isNaN(w)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
h+"; font-size:"+m+"px; font-weight:"+v+";";if(!pa){var oa=document.body;pa=document.createElement("span");pa.innerHTML="";var E=document.createTextNode("Mpgyi");pa.appendChild(E);oa.appendChild(pa)}pa.style.display="";pa.setAttribute("style",h);w=Math.round(pa.offsetHeight);pa.style.display="none"}catch(x){w=Math.ceil(1.1*m)}w=Math.max(w,m);Ya[t]=w}return w}function N(h,m){var v=[];if(v={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var t=0;t<v.length;t++)v[t]*=m;else v=[];return v}function J(h,m,v,w,sa){w=w||[];sa=t(sa)?fb?{passive:!1,capture:!1}:!1:sa;w.push([h,m,v,sa]);return h.addEventListener?(h.addEventListener(m,v,sa),v):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};v.call(h,m)},h.attachEvent("on"+
m,w),w):!1}function gb(h){if(h._menuButton)h.exportEnabled?(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),Ka(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ta(h._menuButton);else if(h.exportEnabled&&w){var m=!1;h._menuButton=document.createElement("button");ua(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);J(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);J(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||
h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);J(h._menuButton,"mousemove",function(){m||(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&ga(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);J(h._menuButton,
...
h.allDOMEventHandlers,!0),J(v,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",v.innerHTML=h._cultureInfo.savePNGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),J(v,"touchstart",function(h){m=!0},h.allDOMEventHandlers),J(v,"mousemove",function(){m||(this.style.backgroundColor=
h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Za(h,m,v){h*=ja;m*=ja;h=v.getImageData(h,m,2,2).data;m=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|
h[v]!==h[v+12]){m=!1;break}return m?h[0]<<16|h[1]<<8|h[2]:0}function ka(h,m,v){return h in m?m[h]:v[h]}function La(h,m,v){if(w&&$a){var t=h.getContext("2d");Ma=t.webkitBackingStorePixelRatio||t.mozBackingStorePixelRatio||t.msBackingStorePixelRatio||t.oBackingStorePixelRatio||t.backingStorePixelRatio||1;ja=Ra/Ma;h.width=m*ja;h.height=v*ja;Ra!==Ma&&(h.style.width=m+"px",h.style.height=v+"px",t.scale(ja,ja))}else h.width=m,h.height=v}function hb(h){if(!ib){var m=!1,v=!1;"undefined"===typeof wa.Chart.creditHref?
(h.creditHref=fa("iuuqr;..b`ow`rkr/bnl."),h.creditText=fa("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),v=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),h._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(h.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
...
var v=document.createElement("canvas");v.setAttribute("class","canvasjs-chart-canvas");La(v,h,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(v);return v}function ga(h,m){for(var v in m)h.style[v]=m[v]}function ua(h,m,v){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",ga(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
v&&(m.setAttribute("state",v),m.setAttribute("type","button"),ga(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[v+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />")}function Ka(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Sa(h,m,v,t,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof v?m:v;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof t&&(h=Math.min(t,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof v?m:v}function I(h,m,v,w,x){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=x;this._eventListeners=[];
...
[]}function Ia(h){var m;h&&Ja[h]&&(m=Ja[h]);Ia.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ga=!1,Fa={},w=!!document.createElement("canvas").getContext,wa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
K,V,T,ca,W;V="#333333";T="#000000";K="#666666";W=ca="#000000";var ba=20,F=14,Va={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Da,fontSize:32,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:F,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:F,indexLabelFontColor:V,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:V,
...
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,
labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:x,fontSize:14,fontColor:V,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};T=V="#F5F5F5";K="#FFFFFF";ca="#40BAF1";W="#F5F5F5";var ba=20,F=14,ab={colorSet:"colorSet2",title:{fontFamily:x,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:F,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:F,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",
...
scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:x,fontSize:14,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};T=V="#F5F5F5";K="#FFFFFF";
ca="#40BAF1";W="#F5F5F5";ba=20;F=14;Da={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Da,fontSize:32,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:F,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:F,
indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,
labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:V,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}};K="#FFFFFF";T=V="#FAFAFA";ca="#40BAF1";W="#F5F5F5";
var ba=20,F=14,bb={light1:Va,light2:ab,dark1:Da,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:x,fontSize:32,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:F,fontColor:V,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,
indexLabelFontSize:F,indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,
labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:F,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:W,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:V,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Va,theme2:ab,theme3:Va},U={numberDuration:1,
...
d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return I?"UTC":(String(F).match(x)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+Y(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+Y(Math.floor(Math.abs(f)/60),2)+Y(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,m,v){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var t=0>h?!0:!1;t&&(h*=-1);var w=v?
v.decimalSeparator:".",x=v?v.digitGroupSeparator:",",E="";m=String(m);var E=1,F=v="",N=-1,P=[],K=[],R=0,J=0,U=0,I=!1,T=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var M=0;F&&M<F.length;M++)if(m=F[M],"."===m&&0>N)N=M;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){E/=Math.pow(1E3,m.length-1);N=M+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(I=!0);0>N?(P.push(m),"#"===m||"0"===m?R++:","===m&&
U++):(K.push(m),"#"!==m&&"0"!==m||J++)}I&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),T=0===h?0:0===m?-(R+F):String(m).length-R,E/=Math.pow(10,T));0>N&&(N=M);E=(h*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(I=F=M=J=N=0;0<P.length;)if(m=P.pop(),"#"===m||"0"===m)if(N++,N===R){var X=E,E=[];if("0"===m)for(m=R-J-(X?X.length:0);0<m;)X.unshift("0"),m--;for(;0<X.length;)v=X.pop()+v,I++,0===I%F&&(M===U&&0<X.length)&&(v=x+v)}else 0<E.length?
(v=E.pop()+v,J++,I++):"0"===m&&(v="0"+v,J++,I++),0===I%F&&(M===U&&0<E.length)&&(v=x+v);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(M++,F=I,I=0,0<E.length&&(v=x+v)):v=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+v:m+v:(m=0>T?m.replace("+","").replace("-",""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return Y(T,a.length)}));x="";for(P=!1;0<K.length;)m=K.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?
(x+=h.shift(),P=!0):"0"===m&&(x+="0",P=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?x+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?x+=m:(m=0>T?m.replace("+","").replace("-",""):m.replace("-",""),x+=m.replace(/[0]+/,function(a){return Y(T,a.length)}));v+=(P?w:"")+x;return t?"-"+v:v},Na=function(h){var m=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,v=
h.layerY):(m=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:m,y:v}},$a=!0,Ra=window.devicePixelRatio||1,Ma=1,ja=$a?Ra/Ma:1,Z=function(h,m,v,t,w,x,E,F,N,P,R,K,J){"undefined"===typeof J&&(J=1);E=E||0;F=F||"black";var I=15<t-m&&15<w-v?8:0.35*Math.min(t-m,w-v);h.beginPath();h.moveTo(m,v);h.save();h.fillStyle=x;h.globalAlpha=J;h.fillRect(m,v,t-m,w-v);h.globalAlpha=1;0<E&&(J=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=F,h.moveTo(m,v),h.rect(m-J,v-J,t-m+2*J,w-v+2*J),h.stroke());
h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+I,v+I),h.lineTo(t-I,v+I),h.lineTo(t,v),h.closePath(),E=h.createLinearGradient((t+m)/2,v+I,(t+m)/2,v),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+I,w-I),h.lineTo(t-I,w-I),h.lineTo(t,w),h.closePath(),E=h.createLinearGradient((t+m)/2,w-I,(t+m)/2,w),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=
E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+I,v+I),h.lineTo(m+I,w-I),h.lineTo(m,w),h.closePath(),E=h.createLinearGradient(m+I,(w+v)/2,m,(w+v)/2),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===K&&(h.save(),h.beginPath(),h.moveTo(t,v),h.lineTo(t-I,v+I),h.lineTo(t-I,w-I),h.lineTo(t,w),E=h.createLinearGradient(t-I,(w+v)/2,t,(w+v)/2),E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=
E,E.addColorStop(0,x),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},fa=function(h){for(var m="",t=0;t<h.length;t++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(t));return m},ib=window&&(window[fa("mnb`uhno")]&&window[fa("mnb`uhno")].href&&window[fa("mnb`uhno")].href.indexOf&&(-1!==window[fa("mnb`uhno")].href.indexOf(fa("b`ow`rkr/bnl"))||-1!==window[fa("mnb`uhno")].href.indexOf(fa("gdonqhy/bnl"))||-1!==window[fa("mnb`uhno")].href.indexOf(fa("gheemd"))))&&
...
this._eventListeners[h]||[],this._eventListeners[h].push({context:t||this,eventHandler:m}))};I.prototype.removeEventListener=function(h,m){if(h&&m&&this._eventListeners[h])for(var t=this._eventListeners[h],w=0;w<t.length;w++)if(t[w].eventHandler===m){t[w].splice(w,1);break}};I.prototype.removeAllEventListeners=function(){this._eventListeners=[]};I.prototype.dispatchEvent=function(h,m,t){if(h&&this._eventListeners[h]){m=m||{};for(var w=this._eventListeners[h],x=0;x<w.length;x++)w[x].eventHandler.call(w[x].context,
...
this._wrappedText.lines[t];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-F.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-F.width/2+this.leftPadding;this.ctx.fillText(F.text,w,x);x+=F.height}this.ctx.font=m;h&&this.ctx.restore()}};ha.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ha.prototype.measureText=function(){this._lineHeight=Xa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ha.prototype._getLineWithWidth=function(h,m,t){h=String(h);if(!h)return{text:"",width:0};var w=t=0,x=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();w<=x;){var F=Math.floor((w+x)/2),E=h.substr(0,F+1);t=this.ctx.measureText(E).width;
if(t<m)w=F+1;else if(t>m)x=F-1;else break}t>m&&1<E.length&&(E=E.substr(0,E.length-1),t=this.ctx.measureText(E).width);m=!0;if(E.length===h.length||" "===h[E.length])m=!1;m&&(h=E.split(" "),1<h.length&&h.pop(),E=h.join(" "),t=this.ctx.measureText(E).width);return{text:E,width:t}};ha.prototype._wrapText=function(){var h=new String(Ea(String(this.text))),m=[],t=this.ctx.font,w=0,x=0;this.ctx.font=this._getFontString();if(0===this.frontSize)x=w=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;m.push(E);var I=x,x=Math.max(x,E.width),w=w+E.height,h=Ea(h.slice(E.text.length,h.length));F&&w>F&&(E=m.pop(),w-=E.height,x=I)}this._wrappedText={lines:m,width:x,height:w};this.width=x+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=t};ha.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Ta,I);na(xa,I);xa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,x=m.y1,F=0,I=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,J;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-E*("center"===this.horizontalAlign?2:1)),I=0.5*m.height-this.margin-2,F=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),I=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),I=0.5*m.height-4));var P;t(this.padding)||"number"!==typeof this.padding?t(this.padding)||"object"!==
...
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new P(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new V(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function V(a,d,c){V.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function Y(a,d){Y.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
...
this.layoutManager=new Ca(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new K(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=t(this.options.data[c].linkedDataSeriesIndex)?
...
this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var Pa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,u=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(p.dataPoints[q].x&&p.dataPoints[q].x.getTime||"dateTime"===p.xValueType)f=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(f=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=t(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var m=
b/p.dataPoints[q-1].x;1>m&&(m=1/m);c.minDiff>m&&1!==m&&(c.minDiff=m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<Pa&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;p.dataPoints[q].label&&
(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,B=Math.min(e,B)):s[b]?s[b]+=e:(s[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?
(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,s)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=s));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,B)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in s)s.hasOwnProperty(q)&&!isNaN(q)&&
(a=s[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,s=!1,B=[],k=0;k<a.dataSeriesIndexes.length;k++){var n=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,r;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var h=
...
Infinity;if(n.dataPoints[p].x&&n.dataPoints[p].x.getTime||"dateTime"===n.xValueType)f=!0;for(p=0;p<n.dataPoints.length;p++){"undefined"===typeof n.dataPoints[p].x&&(n.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));n.dataPoints[p].x.getTime?(f=!0,b=n.dataPoints[p].x.getTime()):b=n.dataPoints[p].x;e=t(n.dataPoints[p].y)?null:n.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/n.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-n.dataPoints[p-
1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);t(e)||null===n.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/n.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-n.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===
e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(s=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=t(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=t(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!s?(d.max=t(d.viewPortMax)?
...
b=0,e=0,f=0,l=f=e=0,s=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),s=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),B=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ka("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=ka("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ka("indexLabelLineDashType",n.dataPoint,n.dataSeries),u=ka("indexLabelLineColor",n.dataPoint,n.dataSeries),y=t(n.dataPoint.indexLabelLineThickness)?t(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,z={percent:null,total:null},C=null;if(0<=n.dataSeries.type.indexOf("stacked")||
...
n.point.y<c.y2||!x))&&(d.lineWidth=y,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(N(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:B+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-s):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<n.point.y?0:-k)+s:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===
C?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=t(h)?w?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
y,t,c);f.push(A);D=R(D);w&&f.push({x:y,y:t,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:y,y:t},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}X.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,y,t,c),f.push(D),A=R(A),w&&f.push({x:y,y:t,ctx:b,type:D.type,size:D.size,color:A,borderColor:A,borderThickness:D.borderThickness});(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:y,y:t},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],s=0;s<a.dataSeriesIndexes.length;s++){var B=a.dataSeriesIndexes[s],k=this.data[B];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,u,t,z=[];b.beginPath();if(0<n.length)for(t=!1,m=0;m<n.length;m++)if(u=n[m].getTime?n[m].x.getTime():n[m].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!t)))if("number"!==typeof n[m].y)0<m&&!t&&(k.connectNullData?b.setLineDash&&(0<z.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(z[z.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(z),z=[])),t=!0;else{u=a.axisX.convertValueToPixel(u);t=a.axisY.convertValueToPixel(n[m].y);var C=k.dataPointIds[m];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:m,x1:u,y1:t};z[z.length]={x:u,y:t};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,z[z.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,z[z.length-1].newLineDashArray=N(p,k.lineThickness)):(p=k.lineDashType,
z[z.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,u,t,b);l.push(D);C=R(C);w&&l.push({x:u,y:t,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:u,y:t},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});t=!1}d(z)}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);s=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=s,s=k);s>u&&(b=s,s=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Z(c,l,s,m,u,b,0,null,h&&0<=r[f].y,
0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:s,x2:m,y2:u};b=R(b);w&&Z(this._eventManager.ghostCtx,l,s,m,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?s:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,
...
return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],s=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?
...
animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],s=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
l=a.axisY.convertValueToPixel(r[f].y);s=a.axisX.reversed?s+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:s-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?s-p<<0:s+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Z(c,u,s,l,m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:s,x2:l,y2:m};b=R(b);
w&&Z(this._eventManager.ghostCtx,u,s,l,m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:u,y:s+(m-s)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:s,x2:Math.max(u,l),y2:m},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var A=f[b]?f[b]:0;D=q+A;n+=A;f[b]=A+(n-D)}else A=l[b]?l[b]:0,D=n-A,n=q-A,l[b]=A+(n-D);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];Z(c,D,z,n,C,b,0,null,t,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:z,x2:n,y2:C};b=R(b);w&&Z(this._eventManager.ghostCtx,D,z,n,C,b,0,null,!1,!1,!1,!1);
...
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
else if(n=a.axisY.convertValueToPixel(z),0<=u[k].y){var A=f[b]?f[b]:0;z=q+A;n+=A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=A+(n-z)}else A=l[b]?l[b]:0,z=n-A,n=q-A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-z)&&(z=e.x1),l[b]=A+(n-z);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];Z(c,z,C,n,D,b,0,null,t,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:C,x2:n,
y2:D};b=R(b);w&&Z(this._eventManager.ghostCtx,z,C,n,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:m,point:{x:0<=u[k].y?n:z,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:C,x2:Math.max(z,n),y2:D},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:
...
t>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==typeof r[h].y)g.connectNullData||(ia||d)||b(),ia=!0;else{m=a.axisX.convertValueToPixel(t);u=a.axisY.convertValueToPixel(r[h].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,D=n,c=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(m,u),w&&l.lineTo(m,u)):(f.beginPath(),f.moveTo(m,u),w&&
(l.beginPath(),l.moveTo(m,u)),D={x:m,y:u}),ia=d=!1):(f.lineTo(m,u),w&&l.lineTo(m,u),0==h%250&&b());n={x:m,y:u};h<r.length-1&&(x!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(O))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u};0!==r[h].markerSize&&
(0<r[h].markerSize||0<g.markerSize)&&(t=g.getMarkerProperties(h,m,u,f),B.push(t),$=R($),w&&B.push({x:m,y:u,ctx:l,type:t.type,size:t.size,color:$,borderColor:$,borderThickness:t.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();X.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
b.clip();w&&(e.beginPath(),e.rect(s.x1,s.y1,s.width,s.height),e.clip());for(var B=0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=R(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,u=null,t=[];if(0<p.length){var z=n._colorSet[q%n._colorSet.length],C=n.lineColor=n.options.lineColor||z,D=C;b.fillStyle=z;b.strokeStyle=
C;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=N(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,E=N(A,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<t.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(t[t.length-1].newLineDashArray=x,
A=n.nullDataLineDashType):(d(),t=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var S=n.dataPointIds[q];this._eventManager.objectMap[S]={id:S,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};t[t.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||A!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||C,t[t.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(A=p[q].lineDashType,t[t.length-1].newLineDashArray=N(A,n.lineThickness)):
(A=n.lineDashType,t[t.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var O=n.getMarkerProperties(q,g,r,b);l.push(O);S=R(S);w&&l.push({x:g,y:r,ctx:e,type:O.type,size:O.size,color:S,borderColor:S,borderThickness:O.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:z});
...
dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=s.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),
...
B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,m,u,t,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;var S="solid";if(f.setLineDash){var O=N(g.nullDataLineDashType,g.lineThickness),S=g.lineDashType,E=N(S,g.lineThickness);f.setLineDash(E)}for(;h<
r.length;h++)if(t=r[h].x.getTime?r[h].x.getTime():r[h].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=u;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(t),u=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||S===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,D=n,S=g.nullDataLineDashType,
f.setLineDash(O)),f.lineTo(m,$),f.lineTo(m,u),w&&(l.lineTo(m,$),l.lineTo(m,u))):(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),D={x:m,y:u}),c=d=!1):(f.lineTo(m,$),w&&l.lineTo(m,$),f.lineTo(m,u),w&&l.lineTo(m,u),0==h%250&&b()),n={x:m,y:u},h<r.length-1&&(x!==(r[h].lineColor||v)||S!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(S=r[h].lineDashType,f.setLineDash(N(S,g.lineThickness))):(S=g.lineDashType,f.setLineDash(E)))),
t=g.dataPointIds[h],this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&($=g.getMarkerProperties(h,m,u,f),B.push($),t=R(t),w&&B.push({x:m,y:u,ctx:l,type:$.type,size:$.size,color:t,borderColor:t,borderThickness:$.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:m,
...
[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];A=this.data[D];v=A.dataPoints;y=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=R(q);t.fillStyle=q;if(0<n.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,S=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;z="solid";if(b.setLineDash){var O=
N(A.nullDataLineDashType,A.lineThickness);z=A.lineDashType;var E=N(z,A.lineThickness);b.setLineDash(E)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||y)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var la=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
ea.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ea.y),r-=la;k.push({x:g,y:m-la});h[f]=m-r;y||$?(!y&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||z===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(y=k.pop(),z=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(z),k.push(y),z=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),w&&t.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(t.beginPath(),
t.moveTo(g,r))),$=y=!1):(b.lineTo(g,r),w&&t.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&t.moveTo(g,r),k.push({x:g,y:m-la})));u={x:g,y:r};q<v.length-1&&(S!==(v[q].lineColor||x)||z!==(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-la}),S=v[q].lineColor||x,b.strokeStyle=S,b.setLineDash&&(v[q].lineDashType?(z=v[q].lineDashType,b.setLineDash(N(z,A.lineThickness))):(z=A.lineDashType,b.setLineDash(E))));if(0<=A.dataPointIndexes[f]){var F=A.dataPointIds[A.dataPointIndexes[f]];
this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(la=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(la),f=R(F),w&&l.push({x:g,y:r,ctx:t,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",
dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&t.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(s.x1,s.y1,s.width,s.height),t.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(z.closePath(),z.fill(),z.beginPath());k=[]}
...
A=this.data[v],x=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<x.length;q++)v=x[q].x.getTime?x[q].x.getTime():x[q].x,A.dataPointIndexes[v]=q,e[v]||(n.push(v),e[v]=!0);n.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){v=a.dataSeriesIndexes[C];A=this.data[v];x=A.dataPoints;t=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:v};e=R(e);z.fillStyle=e;k=[];if(0<n.length){var e=A._colorSet[q%A._colorSet.length],E=A.lineColor=A.options.lineColor||e,S=E;b.fillStyle=e;b.strokeStyle=
E;b.lineWidth=A.lineThickness;u="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);u=A.lineDashType;var F=N(u,A.lineThickness);b.setLineDash(F)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=A.dataPointIndexes[f]?x[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||t)||d(),$=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):
0;g=a.axisX.convertValueToPixel(f);var aa=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=aa;k.push({x:g,y:y-aa});h[f]=y-r;t||$?(!t&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||u===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(t=k.pop(),u=k[k.length-1],d(),b.moveTo(m.x,
m.y),k.push(u),k.push(t),u=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),w&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(z.beginPath(),z.moveTo(g,r))),$=t=!1):(b.lineTo(g,r),w&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&z.moveTo(g,r),k.push({x:g,y:y-aa})));m={x:g,y:r};q<x.length-1&&(S!==(x[q].lineColor||E)||u!==(x[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-aa}),S=x[q].lineColor||E,b.strokeStyle=S,b.setLineDash&&(x[q].lineDashType?(u=x[q].lineDashType,
b.setLineDash(N(u,A.lineThickness))):(u=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(aa=A.getMarkerProperties(q,g,r,b),s.push(aa),f=R(G),w&&s.push({x:g,y:r,ctx:z,type:aa.type,size:aa.size,color:f,borderColor:f,borderThickness:aa.borderThickness}));
(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>x[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&z.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(s);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),z.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var Pa=a.dataSeriesIndexes[m],u=this.data[Pa],y=u.dataPoints;if(0<y.length)for(var z=5<r&&u.bevelEnabled?!0:!1,s=0;s<y.length;s++)if(y[s].getTime?g=y[s].x.getTime():g=y[s].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!t(y[s].y)&&y[s].y.length&&"number"===typeof y[s].y[0]&&"number"===typeof y[s].y[1]&&"number"===typeof y[s].y[2]&&"number"===typeof y[s].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[s].y[0]);
n=a.axisY.convertValueToPixel(y[s].y[1]);p=a.axisY.convertValueToPixel(y[s].y[2]);q=a.axisY.convertValueToPixel(y[s].y[3]);var C=h-r/2<<0,v=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[s].color?y[s].color:u._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,E=u.dataPointIds[s];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:Pa,dataPointIndex:s,x1:C,y1:k,x2:v,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();
c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===u.type?(c.moveTo(h-x,n),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),Z(c,C,Math.min(k,q),v,Math.max(k,q),y[s].y[0]<=y[s].y[3]?u.risingColor:f,A,e,z,z,!1,!1,u.fillOpacity),w&&(e=R(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,Math.min(k,q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),Z(b,C,Math.min(k,q),v,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-
x,n),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(v,q),c.stroke(),w&&(e=R(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(v,q),b.stroke()));(y[s].indexLabel||u.indexLabel||y[s].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[s],dataSeries:u,point:{x:C+(v-C)/2,y:a.axisY.reversed?
p:n},direction:1,bounds:{x1:C,y1:Math.min(n,p),x2:v,y2:Math.max(n,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,s,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?
...
z[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:x,P=z[l].lineDashType?z[l].lineDashType:y.lineDashType,L=1===Math.round(K)%2?0.5:0,T=y.upperBoxColor,va=y.lowerBoxColor,qa=t(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:D,y1:h,x2:A,y2:k,x3:s,y3:n,x4:s,y4:p,y5:q,borderThickness:x,color:e,stemThickness:aa,stemColor:la,whiskerThickness:O,whiskerLength:$,whiskerColor:S,
lineThickness:K,lineColor:J};c.save();0<aa&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=aa,c.setLineDash&&c.setLineDash(N(I,aa)),c.moveTo(s-G,k),c.lineTo(s-G,h),c.stroke(),c.moveTo(s-G,p),c.lineTo(s-G,n),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();Z(c,D,Math.min(q,k),A,Math.max(k,q),va,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();Z(c,D,Math.min(n,q),A,Math.max(q,n),T,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(D-E,Math.min(k,n)-E,A-D+2*E,Math.max(k,
n)-Math.min(k,n)+2*E);c.stroke();c.save();0<K&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(P,K)),c.strokeStyle=J,c.lineWidth=K,c.moveTo(D,q-L),c.lineTo(A,q-L),c.stroke());c.restore();c.save();0<O&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,O)),c.strokeStyle=S,c.lineWidth=O,c.moveTo(s-$/2<<0,p-ea),c.lineTo(s+$/2<<0,p-ea),c.stroke(),c.moveTo(s-$/2<<0,h+ea),c.lineTo(s+$/2<<0,h+ea),c.stroke());c.restore();w&&(e=R(Q),b.strokeStyle=e,b.lineWidth=aa,0<aa&&(b.moveTo(s-E-G,k),b.lineTo(s-
E-G,Math.max(h,p)),b.stroke(),b.moveTo(s-E-G,Math.min(h,p)),b.lineTo(s-E-G,n),b.stroke()),Z(b,D,Math.max(k,n),A,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<O&&(b.beginPath(),b.lineWidth=O,b.moveTo(s+$/2,p-ea),b.lineTo(s-$/2,p-ea),b.stroke(),b.moveTo(s+$/2,h+ea),b.lineTo(s-$/2,h+ea),b.stroke()));(z[l].indexLabel||y.indexLabel||z[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:z[l],dataSeries:y,point:{x:D+(A-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,
...
s;s=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:v,y2:s};Z(c,m,l,v,s,b,0,b,r,r,!1,!1,q.fillOpacity);b=R(u);w&&Z(this._eventManager.ghostCtx,m,l,v,s,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?s:l},direction:g[f].y[1]>=g[f].y[0]?
...
0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(A?v:1))<<0;this.dataPointMaxWidth&&e>s&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,s));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&s<e)&&(s=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>s&&(u=s);if(0<D.length)for(var F=C._colorSet,s=0;s<D.length;s++){var e=C.lineColor=C.options.color?C.options.color:F[0],S={color:D[s].whiskerColor?
D[s].whiskerColor:D[s].color?C.whiskerColor?C.whiskerColor:D[s].color:C.whiskerColor?C.whiskerColor:e,thickness:t(D[s].whiskerThickness)?C.whiskerThickness:D[s].whiskerThickness,dashType:D[s].whiskerDashType?D[s].whiskerDashType:C.whiskerDashType,length:t(D[s].whiskerLength)?t(C.options.whiskerLength)?u:C.options.whiskerLength:D[s].whiskerLength,trimLength:t(D[s].whiskerLength)?t(C.options.whiskerLength)?50:0:0};S.length="number"===typeof S.length?0>=S.length?0:S.length>=u?u:S.length:"string"===typeof S.length?
parseInt(S.length)*u/100>u?u:parseInt(S.length)*u/100>u:u;S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;var O={color:D[s].stemColor?D[s].stemColor:D[s].color?C.stemColor?C.stemColor:D[s].color:C.stemColor?C.stemColor:e,thickness:D[s].stemThickness?D[s].stemThickness:C.stemThickness,dashType:D[s].stemDashType?D[s].stemDashType:C.stemDashType};O.thickness="number"===typeof O.thickness?0>O.thickness?0:Math.round(O.thickness):2;D[s].getTime?r=D[s].x.getTime():r=D[s].x;
if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!t(D[s].y)&&D[s].y.length&&"number"===typeof D[s].y[0]&&"number"===typeof D[s].y[1]){var ia=a.axisX.convertValueToPixel(r);b?k=ia:h=ia;ia=a.axisY.convertValueToPixel(D[s].y[0]);b?n=ia:q=ia;ia=a.axisY.convertValueToPixel(D[s].y[1]);b?p=ia:g=ia;b?(q=a.axisX.reversed?k+(A?v:1)*u/2-(A?E-1:0)*u<<0:k-(A?v:1)*u/2+(A?E-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(A?v:1)*u/2-(A?E-1:0)*u<<0:h-(A?v:1)*u/2+(A?E-1:0)*u<<
0,p=a.axisX.reversed?n-u<<0:n+u<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&n>p&&(ia=n,n=p,p=ia);ia=C.dataPointIds[s];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:s,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:O,whiskerProperties:S};x(c,Math.min(n,p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,S,O,b);w&&x(this._eventManager.ghostCtx,n,q,p,g,e,S,O,b);if(D[s].indexLabel||C.indexLabel||D[s].indexLabelFormatter||
...
n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var v=a.axisX.reversed?h-n<<0:h+n<<0;l>s&&(b=l,l=s,s=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Z(c,l,h,s,v,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:s,y2:v};b=R(b);w&&Z(this._eventManager.ghostCtx,l,h,s,v,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||
...
this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=R(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,t,u,y=null;if(0<p.length){var z=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||z,D=v;b.fillStyle=z;b.strokeStyle=v;b.lineWidth=n.lineThickness;var A="solid";if(b.setLineDash){var x=N(n.nullDataLineDashType,n.lineThickness),A=n.lineDashType,E=N(A,n.lineThickness);b.setLineDash(E)}for(var S=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||
u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!S)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);m=a.axisY.convertValueToPixel(p[g].y[0]);t=a.axisY.convertValueToPixel(p[g].y[1]);q||S?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||A===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,A=n.nullDataLineDashType,b.setLineDash(x)),b.lineTo(r,m),w&&e.lineTo(r,
m),h.push({x:r,y1:m,y2:t})):(b.beginPath(),b.moveTo(r,m),y={x:r,y:m},h=[],h.push({x:r,y1:m,y2:t}),w&&(e.beginPath(),e.moveTo(r,m))),S=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:t}),w&&e.lineTo(r,m),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:t};g<p.length-1&&(D!==(p[g].lineColor||v)||A!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||v,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&
(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=N(A,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var O=n.getMarkerProperties(g,r,t,b);f.push(O);var F=R(u);w&&f.push({x:r,y:t,ctx:e,type:O.type,size:O.size,color:F,borderColor:F,borderThickness:O.borderThickness});O=n.getMarkerProperties(g,r,m,b);f.push(O);F=R(u);w&&f.push({x:r,
y:m,ctx:e,type:O.type,size:O.size,color:F,borderColor:F,borderThickness:O.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:t},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,
...
d[f-2].y,d[f-3].x,d[f-3].y),w&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();w&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(t[g].newStrokeStyle||t[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),t[g].newStrokeStyle&&(b.strokeStyle=t[g].newStrokeStyle),t[g].newLineDashArray&&
b.setLineDash(t[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}d=v(t,2);b.moveTo(d[0].x,d[0].y);for(g=f=0;f<d.length-3;f+=3,g++){if(t[g].newStrokeStyle||t[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),t[g].newStrokeStyle&&(b.strokeStyle=t[g].newStrokeStyle),t[g].newLineDashArray&&b.setLineDash(t[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var s=0;s<a.dataSeriesIndexes.length;s++){var h=a.dataSeriesIndexes[s],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=R(f);e.fillStyle=f;var f=[],p=0,q,
g,m,t=[],x=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,z=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var A=N(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=N(C,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===
typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);m=a.axisY.convertValueToPixel(n[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:m};t[t.length]={x:q,y:g};x[x.length]={x:q,y:m};p<n.length-1&&(z!==(n[p].lineColor||y)||C!==(n[p].lineDashType||k.lineDashType))&&(z=n[p].lineColor||y,t[t.length-1].newStrokeStyle=z,b.setLineDash&&(n[p].lineDashType?(C=n[p].lineDashType,
t[t.length-1].newLineDashArray=N(C,k.lineThickness)):(C=k.lineDashType,t[t.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var S=R(E);w&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:S,borderColor:S,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,m,b);f.push(F);S=R(E);w&&f.push({x:q,y:m,ctx:e,type:F.type,size:F.size,color:S,borderColor:S,borderThickness:F.borderThickness})}if(n[p].indexLabel||
k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:m},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<t.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(t[t.length-
1].newLineDashArray=A,C=k.nullDataLineDashType):(d(D,y),t=[],x=[])),g=!0;d(D,y);X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
...
a.dataSeriesIndexes[g],t=this.data[m],v=t.dataPoints,e=t._colorSet[0];t.risingColor=t.options.risingColor?t.options.risingColor:e;t.fallingColor=t.options.fallingColor?t.options.fallingColor:"#e40a0a";var u="number"===typeof t.options.lineThickness?Math.round(t.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var z=5<q&&t.bevelEnabled?!0:!1,C=!1,x=null,A=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&t.connectNullData)var E=
...
g)*q<<0;var F=a.axisX.reversed?s-q<<0:s+q<<0;h>k&&(e=h,h=k,k=e);a.axisY.reversed&&(e=h,h=k,k=e);e=t.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:l,x1:s,y1:h,x2:F,y2:k};var S=v[l].color?v[l].color:0<v[l].y?t.risingColor:t.fallingColor;Z(c,s,h,F,k,S,0,S,z,z,!1,!1,t.fillOpacity);e=R(e);w&&Z(this._eventManager.ghostCtx,s,h,F,k,e,0,null,!1,!1,!1,!1);var O,S=s;O="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==
typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?h:k:0<v[l].y?k:h;0<l&&x&&(!C||t.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(N(E,u)),c.beginPath(),c.moveTo(x,A-y),c.lineTo(S,O-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(x,A-y),b.lineTo(S,O-y),0<u&&b.stroke()));C=!1;x=F;A=0<v[l].y?h:k;S=v[l].lineDashType?v[l].lineDashType:t.options.lineDashType?t.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:t.options.lineColor?t.options.lineColor:"#9e9e9e";c.lineWidth=
u;c.setLineDash&&(S=N(S,u),c.setLineDash(S));(v[l].indexLabel||t.indexLabel||v[l].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:t,point:{x:s+(F-s)/2,y:0<=v[l].y?h:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(h,k),x2:F,y2:Math.max(h,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
h.midAngle;h.radius=A;h.percentInnerRadius=F}for(var s,t,a=0;a<n.length;a++){var h=g[a],u=e(a);if(null!==u){s=g[a];t=g[u];var C=0,C=b(s,t)-r;if(0>C){for(var x=t=0,D=0;D<n.length;D++)D!==a&&g[D].hemisphere===h.hemisphere&&(g[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?t++:x++);t=C/(t+x||1)*x;var x=-1*(C-t),I=D=0;"right"===h.hemisphere?(D=f(a,t),x=-1*(C-D),I=f(u,x),+I.toFixed(y)<+x.toFixed(y)&&+D.toFixed(y)<=+t.toFixed(y)&&f(a,-(x-I))):(D=f(u,t),x=-1*(C-D),I=f(a,x),+I.toFixed(y)<+x.toFixed(y)&&
+D.toFixed(y)<=+t.toFixed(y)&&f(u,-(x-I)))}}}}else for(a=0;a<n.length;a++)h=g[a],w="pie"===k.type?0.7*A:0.8*A,u=z.x+w*Math.cos(h.midAngle),t=z.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=t;for(a=0;a<n.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),u*=-1):u=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<u&&(!l&&h.indexLabelText&&
(t="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>t?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*t,0.3*h.indexLabelTextBlock.maxWidth<t&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-z.y)<A||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2-z.y)<A)&&(u/=Math.abs(Math.cos(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)),u=u=0,0<h.indexLabelAngle&&
h.indexLabelAngle<Math.PI?(u=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),u*=-1):u=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<u&&(!l&&h.indexLabelText&&(t=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,u*t)&&f(a,2*t)),Math.abs(h.indexLabelTextBlock.x-z.x)<A&&(u/=Math.abs(Math.sin(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)));var L=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});
...
2,t=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=s.indexLabelTextBlock.x+s.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>t+p||m>B+p||r<u-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-C),0===k%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(L(d,a,c),c=a=-1,d=0)}}0<d&&L(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();m.title&&(m.title.dockInsidePlotArea||"center"===m.title.horizontalAlign&&"center"===m.title.verticalAlign)&&
...
{chart:m})}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<n.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=n[c].color?n[c].color:k._colorSet[c%k._colorSet.length];e>d&&fa(m.plotArea.ctx,g[c].center,
...
0:a/c:(p=Z*Z*b*b-4*Math.abs(Z)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=0==p?0:a/p,h+=a/p,l=!0):(n=(Math.abs(Z)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs(Z),h+=n,h>e&&(h-=n,p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=a/p,h+=a/p,l=!0),b=p)),d.push(n);return d}function b(){if(u&&y){for(var a,b,c,d,e,f,k,l,h,n,p,q,s,m,r,B=[],v=[],z={percent:null,total:null},C=null,A=0;A<y.length;A++)r=Q[A],r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,B[A]=J-r-T;r=0.5*T;for(var A=0,D=y.length-1;A<
...
u.indexLabelWrap:!0;s=u.dataPointIds[A];x._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-A:A]};"inside"===u.indexLabelPlacement&&(B[A]=A!==ba?u.reversed?Q[A].x2-Q[A].x1:Q[A].x3-Q[A].x4:Q[A].x3-Q[A].x6,20>B[A]&&(B[A]=A!==ba?u.reversed?Q[A].x3-Q[A].x4:Q[A].x2-Q[A].x1:Q[A].x2-Q[A].x1,B[A]/=2));s=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[A];if(s>B[A]||0>s)s=B[A];v[A]="inside"===
u.indexLabelPlacement?Q[A].height:!1;z=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:x.options,dataSeries:u,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?b.label:"";0>=n&&(n=0);1E3>s&&1E3-s<r&&(s+=1E3-s);R.roundRect||Aa(R);c=new ha(R,{fontSize:f,
...
q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==Q.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,l;f=(P-K+2*C)/n;l=n;for(var k,h=1;h<l;h++){e=h*f;for(var s=H.length-1;0<=s;s--)!H[s].isDirty&&(H[s].textBlock.y<e&&H[s].textBlock.y+H[s].height>e)&&(k=q(s),!(k>=H.length-1)&&H[s].textBlock.y+H[s].height+ca>H[k].textBlock.y&&(H[s].textBlock.y=H[s].textBlock.y+H[s].height-e>e-H[s].textBlock.y?e+1:e-H[s].height-1))}for(k=Q.length-1;0<k;k--)if(!H[k].isDirty){e=
p(k);if(0>e&&(e=0,H[e].isDirty))break;if(H[k].textBlock.y<H[e].textBlock.y+H[e].height){d=d||k;f=k;for(l=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+ca;){a=a||H[f].textBlock.y+H[f].height;l+=H[f].height;l+=ca;f=e;if(0>=f){f=0;l+=H[f].height;break}e=p(f);if(0>e){f=0;l+=H[f].height;break}}if(f!=k){g=H[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(Q[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=
e[d],f<a)g++,f+=H[b.id].height+ca,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,n=1,m=0;m<2*n;m++){for(var r=H.length-1;0<=r&&!(0<=p(r)&&p(r),f=H[r],g=f.textBlock,k=(l=q(r)<Q.length?H[q(r)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+ca>+k.y.toFixed(6))&&(d=g.y+d+ca-k.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<Q.length?H[b].textBlock.y:
u.reversed?ma+C:qa+C)-(0>a?u.reversed?qa-C:ma-C:H[a].textBlock.y+H[a].height+ca)}function m(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=fa;else{e=C*(1!=W.length||0!=W[0]&&W[0]!=Q.length-1?2:1)/k();for(var s=0;s<Q.length;s++){if(1==W.length&&0==W[0]){if(0===s){l.push(fa[s]);d=h;continue}}else 0===s&&(d=-1*h);l.push(fa[s]+d);if(0<=W.indexOf(s)||s<Q.length&&0<=W.indexOf(s+1))d+=e}}g=function(){for(var a=
...
(a=H[G].textBlock.x+H[G].width,a=(J-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<Q.length;G++)Q[G].x1+=A,Q[G].x2+=A,Q[G].x3+=A,Q[G].x4+=A,Q[G].x5&&(Q[G].x5+=A,Q[G].x6+=A),H[G].textBlock.x+=A}for(G=0;G<Q.length;G++)A=Q[G],pa(R,A,u.fillOpacity),fa.push(A.y1);v(R);I&&u.visible&&("inside"===u.indexLabelPlacement||x.animationEnabled||n(R),x.animationEnabled||r());if(!I)for(G=0;G<y.length;G++)A=u.dataPointIds[G],a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-
1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&O?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(t(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?y[y.length-1-a].exploded=y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;m(x,b,500)}};return{source:R,
dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(m(x,-1,500),v(x.plotArea.ctx||x.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();m.prototype.cancelRequestAnimFrame=window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||
...
g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(t,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-t,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=t;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};na(K,I);K.prototype.getDefaultAxisPlacement=
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var t=ka("markerSize",g,this)||4,w=c?20:t,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=t/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":t=ka("markerSize",g,this)||4;w=c?20:t;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=t/2&&(h=!0);break;case "bubble":t=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=t/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||t(A)||t(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+u>m&&(h+=0<a[g].labelAngle?E+u-m-Z:0):0>a[g].labelAngle?A-v<l&&A-v<a[g].viewportMinimum&&(F=l-(L+a[g].tickLength+x+A-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+u>m&&(h=E+u/2-m-Z),A-v<l&&A-v<a[g].viewportMinimum&&(F=l-L-a[g].tickLength-x-A+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<F?l+=F:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<F&&(l+=F),0<h&&(m-=h))),n.panEnabled?V=t(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=V:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=V,h=Math.round(f.y2-V-e+G),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
...
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),T+=x[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+X+W<Math.max(L,p)?Math.max(L,p):f.y1+X+W),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(V+e+L)),b[g].lineCoordinates=
...
0));M.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-V-W>n.width-10?n.width-10:f.x2-V-W),c[g].labelAutoFit&&!t(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-z/2:0===c[g].labelAngle?m-z/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-V-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-V-W),b[g]&&b[g].labelAutoFit&&!t(x)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,x):0===b[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else"year"===this.intervalType&&(0<a.getMonth()||1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};na(T,I);na(ba,I);ba.prototype.createUserOptions=function(a){if("undefined"!==
...
this.labelFontSize);this.labelMaxWidth=t(this.options.labelMaxWidth)?0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=t(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:2*this.labelFontSize;0<p&&q.setLineDash&&q.setLineDash(N(this.lineDashType,p));k=new ha(q,{x:0,y:0,padding:{top:2,right:3,bottom:2,left:4},backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,maxWidth:this.labelMaxWidth,
...
t(this.options.label)?za(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):t(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&
...
value:c?c:this.parent.convertPixelToValue(a)}):t(this.options.label)?za(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):t(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):
...
this._textBlock=k;t(c)||this.renderLabel();q.globalAlpha=g};V.prototype.renderLabel=function(){t(this._textBlock)||(t(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};na(Y,I);Y.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position=
...
this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&m.push(k))}if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});c=m[0];for(b=0;b<m.length;b++)m[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(m[b]);m=null}else{if(k=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=k.dataPointIndex,this.currentSeriesIndex=k.dataSeries.index;else if(w)if(k=Za(a,d,this.chart._eventManager.ghostCtx),
...
dataPoint:f[b].dataPoint,dataSeries:f[b].dataSeries,dataPointIndex:f[b].index,dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};Y.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(t(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),
